                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        <div class="relative mb-4">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search suppliers by name, contact, email, or phone..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200">
                        </div>
                                        ...
                                        <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 hover:shadow-lg transition">
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-3 space-y-2 mb-4">
                                                ...
                                                <div class="flex items-start text-sm">
                                                    <span class="font-medium text-gray-700 w-24 pt-1">Email:</span>
                                                    <span class="text-gray-600 break-all">{{ $supplier->email }}</span>
                                                </div>
                                                <div class="flex items-center text-sm">
                                            ...
                                            <div class="flex gap-2 pt-3 border-t border-gray-200">
                                                <a href="{{ route('suppliers.edit', $supplier->id) }}" class="flex-1 inline-flex justify-center items-center px-3 py-2 bg-indigo-50 text-indigo-600 rounded-md font-medium text-sm hover:bg-indigo-100 transition">
                                                    Edit
                                                </a>
                                                <button wire:click="delete({{ $supplier->id }})"
                                                        wire:confirm="Are you sure you want to delete this supplier?"
