                ...
                <div class="p-6">
                    ...
                    <form wire:submit.prevent="save" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="sku" class="block text-sm font-medium text-gray-700">SKU <span class="text-gray-500">(optional)</span></label>
                                <div class="mt-1">
                                    <input type="text" id="sku" wire:model.lazy="sku" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="barcode" wire:model.lazy="barcode" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="category_id" wire:model.lazy="category_id" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="supplier_id" wire:model.lazy="supplier_id" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="number" id="reorder_level" wire:model.lazy="reorder_level" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="number" id="current_stock" wire:model.lazy="current_stock" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            ...
                            <div>
                                ...
                                @if ($image)
                                    <div class="mt-3">
                                        ...
                                        <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="w-32 h-32 object-cover rounded-lg shadow-md">
                                    </div>
                                @endif
                            </div>
                        </div>
