    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-inventory.card.card class="overflow-hidden">
                <div class="p-6">
                    <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Create New Product</h1>
