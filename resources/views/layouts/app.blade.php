...
<head>
    ...
    <meta name="description" content="@yield('meta-description', 'Modern professional website')">
    <meta name="keywords" content="@yield('meta-keywords', 'business, professional, modern')">
    ...
    <title>@yield('title', 'Tech Solutions Inc.')</title>
</head>
<body class="bg-gradient-to-br from-slate-50 to-white font-sans antialiased">
    <nav class="bg-white/80 backdrop-blur-md border-b border-slate-200/50 shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="/" class="text-2xl font-bold text-gray-900">TechSolutions</a>
                </div>
                ...
                <div class="flex items-center md:hidden">
                    <button class="text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md p-2">
    ...
    <footer class="bg-gradient-to-r from-slate-700 to-slate-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="space-y-4">
                    <h3 class="text-xl font-semibold">TechSolutions</h3>
                    <p class="text-slate-300">Delivering innovative technology solutions for businesses of all sizes.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="/services#support" class="text-slate-300 hover:text-white transition-colors duration-200">24/7 Support</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center">
                            <svg class="h-5 w-5 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                            <span class="text-slate-300">123 Business Ave, Suite 100</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="h-5 w-5 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="text-slate-300">info@techsolutions.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="mt-12 pt-8 border-t border-slate-700/50 text-center">
                <p class="text-slate-400 text-sm">© {{ date('Y') }} Tech Solutions Inc. All rights reserved.</p>
                <p class="text-slate-400 text-sm mt-2">Made with ❤️ by LaraCopilot</p>
            </div>
        </div>
    </footer>
