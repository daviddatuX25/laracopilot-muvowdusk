...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 bg-white border-b border-gray-200">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Add New Supplier</h1>
        ...
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" id="contact_person" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
            ...
            <div class="mt-6">
                ...
                <a href="{{ route('suppliers.index') }}" class="ml-3 text-gray-600 hover:text-gray-800">
                    Cancel
                </a>
            </div>
        </form>
